 ...
 * ```
 */
export type AuditAction = 'USER_CREATED' | 'USER_UPDATED' | 'USER_ROLE_CHANGED' | 'USER_PASSWORD_RESET' | 'PROJECT_CREATED' | 'PROJECT_UPDATED' | 'PROJECT_DELETED' | 'DATA_CLEARED' | 'ANALYTICS_CLEARED' | 'BULK_ALIGNMENT_STARTED' | 'LIKERT_SCORES_CLEARED' | 'PROJECT_RECORDS_CLEARED' | 'SYSTEM_SETTINGS_UPDATED' | 'BONUS_WINDOW_CREATED' | 'BONUS_WINDOW_UPDATED' | 'BONUS_WINDOW_DELETED' | 'LLM_MODEL_CREATED' | 'LLM_MODEL_UPDATED' | 'LLM_MODEL_DELETED' | 'BULK_EVALUATION_STARTED' | 'BULK_EVALUATION_CANCELLED' | 'RATER_GROUP_CREATED' | 'RATER_GROUP_UPDATED' | 'RATER_GROUP_DELETED' | 'RATER_GROUP_MEMBERS_ADDED' | 'RATER_GROUP_MEMBER_REMOVED' | 'ASSIGNMENT_BATCH_CREATED' | 'ASSIGNMENT_BATCH_UPDATED' | 'ASSIGNMENT_BATCH_DELETED' | 'ASSIGNMENT_BATCH_DISTRIBUTED' | 'POD_CREATED' | 'POD_UPDATED' | 'POD_DELETED' | 'POD_MEMBERS_ADDED' | 'POD_MEMBER_REMOVED' | 'GUIDELINE_CREATED' | 'GUIDELINE_UPDATED' | 'GUIDELINE_DELETED' | 'EXEMPLAR_TASK_CREATED' | 'EXEMPLAR_TASK_UPDATED' | 'EXEMPLAR_TASK_DELETED' | 'DATA_INGESTION_STARTED' | 'DATA_INGESTION_CANCELLED' | 'MEETING_CREATED' | 'MEETING_UPDATED' | 'MEETING_DELETED' | 'PROMPT_AUTHENTICITY_CLEARED' | 'PROMPT_AUTHENTICITY_IMPORTED' | 'AI_CHECK_REQUESTED' | 'AI_LIKERT_LLM_EVALUATION' | 'AI_SIMILARITY_COMPARE' | 'AI_PROMPT_AUTHENTICITY_JOB_STARTED' | 'AI_PROMPT_AUTHENTICITY_DEEP_DIVE_COMPLETED' | 'AI_QUALITY_RATING_JOB_STARTED' | 'API_TOKEN_CREATED' | 'API_TOKEN_REVOKED';
export type EntityType = 'USER' | 'PROJECT' | 'DATA_RECORD' | 'LIKERT_SCORE' | 'SYSTEM_SETTING' | 'BONUS_WINDOW' | 'LLM_MODEL_CONFIG' | 'LLM_EVALUATION_JOB' | 'RATER_GROUP' | 'ASSIGNMENT_BATCH' | 'AI_REQUEST' | 'API_TOKEN' | 'MENTORSHIP_POD' | 'GUIDELINE' | 'EXEMPLAR_TASK' | 'INGEST_JOB' | 'MEETING' | 'PROMPT_AUTHENTICITY_RECORD';
